...
const INVITABLE_BY: Record<string, Role[]> = {
  SUPER_ADMIN:   ["SUPER_ADMIN","ADMIN","OWNER","SHIFT_MANAGER","EDITOR","VIEWER","WAITER","BARTENDER","DISPLAY"],
  ADMIN:         ["ADMIN","OWNER","SHIFT_MANAGER","EDITOR","VIEWER","WAITER","BARTENDER","DISPLAY"],
  OWNER:         ["SHIFT_MANAGER","EDITOR","VIEWER","WAITER","BARTENDER","DISPLAY"],
  SHIFT_MANAGER: ["VIEWER","WAITER","BARTENDER","DISPLAY"],
};
