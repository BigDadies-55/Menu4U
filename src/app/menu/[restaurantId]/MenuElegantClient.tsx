    ...
    >
      ...
      {elegantView === "landing" && (
        <section style={{
          ...
          <div style={{
            ...
            {openStatus && (
              <div style={{
                ...
                <span style={{ width: 7, height: 7, borderRadius: "50%", background: openStatus.open ? "#34D399" : "#FCA5A5", display: "inline-block", boxShadow: openStatus.open ? "0 0 6px #34D399" : "none" }} />
                {openStatus.label}
              </div>
            )}
          ...
          {/* Bottom circular action buttons — all same size, single row */}
          <div style={{
            position: "relative", zIndex: 2,
            ...
            {(() => {
              ...
              const onEnter = (e: React.MouseEvent<HTMLElement>) => { (e.currentTarget as HTMLElement).style.transform = "scale(1.12)"; };
              const onLeave = (e: React.MouseEvent<HTMLElement>) => { (e.currentTarget as HTMLElement).style.transform = "scale(1)"; };
              ...
              return (
                <>
                  ...
                  {/* Phone */}
                  {restaurant.phone && restaurant.showPhonePublic !== false && (
                    <a href={`tel:${restaurant.phone}`} aria-label="התקשר"
                      style={btnStyle} onMouseEnter={onEnter} onMouseLeave={onLeave}>
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C5A880" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
