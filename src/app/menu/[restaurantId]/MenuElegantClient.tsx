      ...
      {elegantView === "landing" && (
        <section style={{
          ...
          <div style={{
            ...
            {/* Welcome text or address (respect showAddressPublic) */}
            {(restaurant.welcomeText || (restaurant.address && restaurant.showAddressPublic !== false)) && (
              <p style={{
          ...
          <div style={{
            ...
            {/* Social links row */}
            {(restaurant.instagram || restaurant.facebook || restaurant.whatsapp || restaurant.tripadvisor || restaurant.googleReview) && (
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 16 }}>
                {restaurant.instagram && (
                  <a href={restaurant.instagram.startsWith("http") ? restaurant.instagram : `https://instagram.com/${restaurant.instagram}`}
                    ...
                    style={{ width: 40, height: 40, borderRadius: "50%", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none", transition: "transform 150ms" }}
                ...
                {restaurant.whatsapp && (
                  <a href={`https://wa.me/${restaurant.whatsapp.replace(/\D/g, "")}`}
                    ...
                    onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1)"; }}
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="#25D366"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12.004 2C6.477 2 2 6.484 2 12.017c0 1.99.52 3.86 1.428 5.484L2 22l4.619-1.401A9.956 9.956 0 0 0 12.004 22C17.523 22 22 17.516 22 11.983 22 6.478 17.523 2 12.004 2zm0 18.044a8.04 8.04 0 0 1-4.217-1.195l-.302-.18-3.13.95.922-3.046-.197-.312A8.029 8.029 0 0 1 3.972 12c0-4.42 3.602-8.016 8.032-8.016 4.428 0 8.03 3.596 8.03 8.016 0 4.423-3.602 8.044-8.03 8.044z"/></svg>
                  </a>
                )}
                {restaurant.tripadvisor && (
                  <a href={restaurant.tripadvisor} target="_blank" rel="noopener noreferrer" aria-label="TripAdvisor"
                    style={{ width: 40, height: 40, borderRadius: "50%", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none", transition: "transform 150ms", fontSize: 20 }}
                    onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1.15)"; }}
                    onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.transform = "scale(1)"; }}
                  >🦉</a>
                )}
