                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map(user => {
                    ...
                    return (
                      ...
                      >
                        {/* ID */}
                        <td style={{ padding: "6px 16px", fontSize: 12, color: L.muted, fontWeight: 500, whiteSpace: "nowrap" }}>
                          {shortId(user.id)}
                        </td>
                        {/* Date */}
                        <td style={{ padding: "6px 16px", fontSize: 12, color: L.muted, whiteSpace: "nowrap" }}>
                        ...
                        {/* Status */}
                        <td style={{ padding: "6px 16px", fontSize: 12, fontWeight: 600, color: status.color, whiteSpace: "nowrap" }}>
                          {status.label}
                        </td>
                        {/* 3-dot menu */}
