...
export default function WaiterPosWrapper(props: { restaurants: { id: string; name: string; waiterBg?: string | null }[]; waiterName: string; isWaiter?: boolean; waiterId?: string }) {
