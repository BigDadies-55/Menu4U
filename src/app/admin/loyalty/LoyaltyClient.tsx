            ...
            <div>
              <div style={CARD}>
                ...
                <div>
                  ...
                  {smsHistoryLoading && (
                    <div style={{ color: T.muted, fontSize: 12, padding: "8px 0" }}>טוען...</div>
                  )}
        ...
        <div style={{
          ...
          >
            ...
            <div style={{ marginTop: 24, textAlign: "center" }}>
              <button onClick={() => setSmsDetailEntry(null)} style={{
                background: "transparent", color: T.muted, border: `1px solid #2d3239`,
                borderRadius: 8, padding: "8px 24px", fontSize: 14, cursor: "pointer",
              }}>סגור</button>
            </div>
          </div>
        </div>
