...
export default function WaiterFloorClient({ restaurants, waiterName }: { restaurants: Restaurant[]; waiterName: string }) {
  ...
  // ── Render ────────────────────────────────────────────────────────
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 40px)", background: C.bg, color: C.text, fontFamily: "system-ui,sans-serif", direction: "rtl", position: "relative", overflow: "hidden" }}>
