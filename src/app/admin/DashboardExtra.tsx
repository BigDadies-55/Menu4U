  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? `0 0 18px ${c.glow}` : "none",
        transition: "all 0.3s ease",
        cursor: "default",
      }}
    >
      <div>
        <span style={{ fontSize: 12, color: G.muted, fontWeight: 500, display: "block", marginBottom: 4 }}>
          {label}
        </span>
        <span style={{ fontSize: 22, fontWeight: 900, color: c.hex, lineHeight: 1 }}>
          {value}
        </span>
      </div>
