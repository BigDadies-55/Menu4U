  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 500, background: "#0c0c12", display: "flex", flexDirection: "column", fontFamily: "'Heebo', sans-serif", direction: "rtl" }}>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden", minHeight: 0 }}>
        ...
        {/* ── Categories (right, 20% / 17% mobile / 20% phone) ── */}
        <div style={{ width: isPhone ? "20%" : isMobile ? "17%" : "20%", background: "#ededed", borderLeft: "1px solid #dcdcdc", overflowY: "auto", flexShrink: 0 }}>
          {loadingMenu ? (
        ...
        {/* ── Dishes (middle, 30% / 25% mobile / 30% phone) ── */}
        <div style={{ width: isPhone ? "30%" : isMobile ? "25%" : "30%", background: "#fff", color: "#1a1612", display: "flex", flexDirection: "column", flexShrink: 0, borderLeft: "1px solid #e3ded5" }}>
