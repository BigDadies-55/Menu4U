...
export function TableOverlay({
  ...
  activeOrderIds, totalAmount, insights, isMobile, freeTables,
        ...
        <div style={{ borderTop: "1px solid #e8e2da", padding: "14px 16px", background: "#fff", flexShrink: 0, display: "flex", flexDirection: "column", gap: 8 }}>
          {isOccupied && order && (
            <>
              ...
              <button onClick={onClose} style={{ padding: 13, borderRadius: 12, border: "1.5px solid #f5c4bc", background: "#fdf2f0", fontSize: 13, fontWeight: 800, cursor: "pointer", color: "#8b2e22", fontFamily: "inherit" }}>
                💳 סגור חשבון
              </button>
            </>
          )}
