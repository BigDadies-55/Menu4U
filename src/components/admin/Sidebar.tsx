...
const GROUPS: NavGroup[] = [
  // ── ניהול עסק ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { href: "/admin/kitchen-management", label: "ניהול מטבח", I: Ic.KDSIcon, ownerOnly: true, waiterHide: true, displayHide: true },
  ...
  // ── ניהול ושירות ─────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { href: "/admin/attendance-manager", label: "נוכחות",    I: Ic.Stats,       displayHide: true, waiterHide: false },
